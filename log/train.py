...
parser.add_argument('--dump_dir', default='/home/wangxiao/Documents/projects/EventNet_benchmark/EVclouds_gesture_recognition/dump', help='dump folder path [dump]')
parser.add_argument('--visu', default=True, help='Whether to dump image for error case [default: False]')
...
GESTURE_NAMES = [line.rstrip() for line in open(os.path.join(BASE_DIR, 'data/gesture_names.txt'))] 
